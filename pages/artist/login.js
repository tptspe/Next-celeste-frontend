...
class LoginPage extends React.Component {
    ...
    constructor(props) {
      ...
      handleSubmit = async(values, { setSubmitting, setErrors, resetForm }) => {
        ...
        axios.post(process.env.SERVER_URL + 'api/auth/login', values)
        .then((response) => {
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="login_footer">
                                ...
                                <div className="link">
                                    <p><span>New to Celeste?</span> &nbsp;<Link href="/artist/signup"><a>Create an account</a></Link></p>
                                    <p><Link href="/client/login"><a>Client Login</a></Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
